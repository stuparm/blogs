# CONFIGURATION
# --------------------------------------------------------------------------------------------
y_min = 48.14430                    # minimum value displayed on y axis (latitude)
y_max = 48.15026                    # maximum value displayed on y axis (latitude)
x_min = 11.55723                    # minimum value displayed on x axis (longitude)
x_max = 11.57143                    # maximum value displayed on x axis (longitude)
inputs = ["input1"]                 # name of the input ports. It cooresponds to x and y axis
