...
def on_input(value1, value2):
    ...
    valxy_1 = value1.split(",")
    valxy_2 = value2.split(",")

    val_x_1 = float(valxy_1[0])
    val_y_1 = float(valxy_1[1])
    val_x_2 = float(valxy_2[0])
    val_y_2 = float(valxy_2[1]

    val_x_1 = calculate_x(val_x_1)
    val_y_1 = calculate_y(val_y_1)
    val_x_2 = calculate_x(val_x_2)
    val_y_2 = calculate_y(val_y_2)

    circle_1 = point.replace("#x_coord",str(val_x_1)).replace("#y_coord", str(val_y_1)).replace("#color", chart_colors[0])
    circle_2 = point.replace("#x_coord",str(val_x_2)).replace("#y_coord", str(val_y_2)).replace("#color", chart_colors[1])
   
   
    points_1 += circle_1
    points_2 += circle_2
    
    html_tmp = html.replace("#points_1", points_1).replace("#points_2", points_2)
